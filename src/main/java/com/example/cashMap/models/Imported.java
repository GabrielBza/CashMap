...
public class Imported implements Serializable{
    ...
    public Imported(Integer importId, Integer accountId, String fileName, String fileHash, LocalDate importedDate) {
    ...
    public Imported(Integer importId, Integer accountId, String fileName, LocalDate importedDate) {
        notNull(fileName, "fileName must not be null");
        notNull(importedDate, "importedDate must not be null");
        this.importId = importId;
        this.accountId = accountId;
